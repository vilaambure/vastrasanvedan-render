const DEFAULT_STORE_CONFIG = {
  ...
  whatsappMessage: "Hello Vastra Sanvedan,\nI want to order:\n{productLines}\n\nTotal: {total}{customerInfo}\n\nPlease confirm availability and delivery details.",
...
function normalizeStoreSettings(raw = {}) {
  ...
  return {
    ...
    whatsappMessage: String(next.whatsappMessage || DEFAULT_STORE_CONFIG.whatsappMessage).trim() || DEFAULT_STORE_CONFIG.whatsappMessage,
